...
$data = tampilkan("SELECT * FROM user");
?>
...
<div class="flex 2xl:flex-row xl:flex-row lg:flex-row flex-col h-screen relative ">
    <nav class="sidebar 2xl:flex xl:flex lg:flex md:flex flex-col items-center bg-yellow-500 2xl:w-2/6 xl:w-2/6 lg:w-2/6 w-full">
        ...
        <section id="product" class="p-3 mt-3 w-full flex flex-col gap-5 max-h-screen overflow-y-scroll">
            <table class="border border-slate-900">
                <tr class="bg-slate-900 text-slate-50">
                    ...
                    <th class="border border-slate-900 px-2">Username</th>
                    <th class="border border-slate-900 px-2">Password</th>
                    <th class="border border-slate-900 px-2">No Telepon</th>
                    <th class="border border-slate-900 px-2">Alamat</th>
                    <th class="border border-slate-900 px-2">Role</th>
                ...
                <tr class="">
                    ...
                    <td class="border border-slate-900 px-2"><?php echo $pelanggan['password'] ?></td>
                    ...
                    <td class=" px-4 border border-slate-900 ">
                        <div class="flex gap-4 p-2">
                            <a href="../hapusCustomer.php?id_pelanggan=<?php echo $pelanggan['id']?>" class="bg-red-500 p-2">
