...
session_start();
$sepatu = tampilkan("SELECT * FROM product WHERE brand= 'Adidas'");
...
<div class="">
        <div class="flex flex-col ">
            ...
            <div class="2xl:flex xl:flex lg:flex md:flex hidden items-center gap-2 text-lg font-bold text-slate-50">
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="adidas.php">Adidas</a>
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="mills.php">Mills</a>
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="nike.php">Nike</a>
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="ortuseight.php">Ortuseight</a>
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="puma.php">Puma</a>
                <a class="hover:bg-slate-900 hover:text-slate-50 px-3 py-2 rounded-xl" href="specs.php">Specs</a>
            </div>
    ...
    <div class="2xl:hidden xl:hidden lg:hidden md:hidden flex items-center gap-2 text-lg font-bold text-slate-900 px-4 py-2">
        ...
        <div class="container mx-auto mt-4">
            <h1 class="mb-4 font-bold text-2xl">Adidas</h1>
            <div class=" p-2 grid grid-cols-2 gap-2 2xl:grid-cols-6 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4">                
                <?php foreach($sepatu['items'] as $value) { ?>    
